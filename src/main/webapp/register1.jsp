		...
		<div class="login-form">
			<!-- <div class="sign-in-htm">
				...
				<div class="group">
					...
					<input  type="password" id ="t2" class="input" data-type="password">
				</div>
				<div class="group">
				...
				<div class="group">
					...
					<input onClick="login()"  type="button" class="button"  value="Sign In">
				</div>
				<label id="niku"></label>
				<div class="hr"></div>
				<div class="foot-lnk">
			...
			<div class="sign-up-htm">
				<div class="group">
					<label for="user" class="label">Username</label>
					<input id="t1" type="text" class="input" >
				</div>
				<div class="group">
					<label for="pass" class="label">Password</label>
					<input  id="t2" type="password" class="input" data-type="password">
				</div>
		
				<div class="group">
					<label for="pass" class="label">Email Address</label>
					<input  id ="t3"  type="text" class="input">
				</div>
				<div class="group">
...
function insert()
{
	...
	//Mail Open
	var userid = "lvWHugx8jRDxt_I-c";
    emailjs.init(userid);
	
	emailjs.send("service_s76q5li","template_9rbv4pe",{
		to_name: t1.value,
		to_email: t3.value,
	});
	...
	xhtml.onreadystatechange = function()
	{
		if(this.readyState == 4 && this.status == 200)
			lbl.innerText = this.responseText;
			sessionStorage.setItem("kart",user);//role
			sessionStorage.setItem("kartikeya",t1.value);//usernaem
			setTimeout(function()
			{
				window.location="http://localhost:8080/profile.jsp";
			},1000);
	};
}
function login()
