...
function login()
{
	...
	var url ="http://localhost:8080/api/login-check/" + user.value + "/" + password.value + "/";
	...
	xhtml.onreadystatechange = function()
	{
		if(this.readyState == 4 && this.status == 200)
			...
			{
				 var username=sessionStorage.setItem("username", user.value);
				 setTimeout(function()
			     {
	                   window.location="http://localhost:8080/dash.jsp";
	             },1000);
			}
